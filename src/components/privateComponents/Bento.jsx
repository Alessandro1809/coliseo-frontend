    ...
    <>
        ...
        <section className="grid grid-cols-4 gap-4 p-2">
            ...
            <article className="col-span-4 bg-[#0d0d0d]/70 rounded-lg h-64 relative overflow-hidden">
                <div className="relative h-full w-full">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center">
                        ...
                        <p className='text-[#ffb58d] md:text-6xl font-bold text-center mix-blend-difference pb-6 text-4xl'>Gestiona, motiva, supera con FitFlare</p>
            ...
            <article className="md:col-span-2 w-full col-span-4">
                <div className="bg-[#0d0d0d]/70 rounded-lg p-4 h-full bg-[radial-gradient(ellipse_60%_45%_at_40%_-20%,rgba(254,22,22,0.3),rgba(255,255,255,0))]">
            ...
            <article className="md:col-span-2 w-full col-span-4">
                <div className="bg-[#0d0d0d]/70 rounded-lg p-4 h-auto text-[#ffb58d] bg-[radial-gradient(ellipse_70%_45%_at_40%_-20%,rgba(254,22,22,0.3),rgba(255,255,255,0))]">
