...
const Register = () => {
  ...
  return (
    <>
      ...
      <h2 className="mb-6 text-4xl font-black tracking-wide text-transparent sm:text-7xl from-red-700 bg-gradient-to-l via-orange-700 to-yellow-500 bg-clip-text">FITFLARE</h2>
      <h1 className="text-3xl font-black tracking-wide text-gray-200 sm:text-6xl">¿Listo para empezar? <br/><span className="text-red-600 ">Crea tu cuenta y Administra tus </span>Clientes.</h1>
